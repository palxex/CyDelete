...
- (void)donate:(id)arg {
    UIAlertController* alert=[UIAlertController alertControllerWithTitle:[self localized:@"DONATE"] message:nil preferredStyle:UIAlertControllerStyleAlert];  
    [alert addAction:[UIAlertAction actionWithTitle:[self localized:@"BITCOIN"] style:UIAlertActionStyleDefault handler:^(UIAlertAction* _Nonnull action)  
        {
            ...
            if([[UIApplication sharedApplication] canOpenURL:targetURL])
                ...
                UIAlertController* alert=[UIAlertController alertControllerWithTitle:@"" message:@"BTC address have been copied in your pasteboard" preferredStyle:UIAlertControllerStyleAlert];  
...
- (void)viewSource:(id)arg {
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://github.com/palxex/CyDelete"]];
}
